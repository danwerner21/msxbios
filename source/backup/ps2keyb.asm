...
WL1:
        IN      A,(KBPPIB)                        ; GET A BYTE FROM PORT B
...
CAPSLOCK
        .EQU    0F419H                            ; location for caps lock, either 00000000 or 11111111
CTRL
        .EQU    0F41AH                            ; location for ctrl on or off 00000000 or 11111111
NUMLOCK
        .EQU    0F41BH                            ; location for num lock
BREAKFLAG
        .EQU    0F41CH                            ; location for BREAK FLAG
