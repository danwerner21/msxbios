...
;* MONITOR ROUTINES
;*
OUT	.EQU	$00A2		;OUTPUT ROUTINE ADDRESS
EXIT	.EQU	DOTINYMON	;TERMINATION RETURN ADDRESS
GETR	.EQU	$00E4		;ROUTINE TO LOAD INTEL HEX FORMAT
TDUMP	.EQU	$00ED		;ROUTINE TO DUMP IN INTEL HEX FORMAT
TON	.EQU	$00E1		;ROUTINE TO START TAPE
TOFF	.EQU	$00E7		;ROUTINE TO STOP TAPE
NL	.EQU	CRLF		;ROUTINE TO PRINT A <LF>, <CR> ON TERMINAL
PMSG	.EQU	prn_text	;DISPLAY'S MSG(HL) UP TO ZERO OR <CR>

;* MEMORY ALLOCATION
BUFF	.EQU	$4000		;START OF RAM, INPUT BUFFER
...
;*
STOR:	LD	BC,VARS		;GET ADDRESS OF VARIABLE TABLE
...
;*
LOOK:	LD	BC,VARS		;ADDRESS OF VARIABLES
...
;* ERROR MESSAGES..
;*
DER:	.TEXT	"DIVIDE BY ZERO" ;DIVIDE BY ZERO
	.DB	0
IERMS:	.TEXT	"BAD DATA - RETRY" ;BAD RESPONSE TO INPUT STATEMENT
	.DB	$0D,$0A,0
CSTK:	.TEXT	"NESTING"	;INVALID FOR/NEXT, GOSUB/RETURN NESTING
	.DB	0
LIN:	.TEXT	"LINE NUMBER"	;GOTO, GOSUB, OR ORDER TO UNKNOWN LINE
	.DB	0
NP:	.TEXT	"NO PROGRAM"	;RUN OR SAVE EMPTY PROGRAM
	.DB	0
INL:	.TEXT	" IN LINE "	;INDICATES LINE ERROR WAS IN
	.DB	0
SYN:	.TEXT	"SYNTAX"	;DOES NOT FOLLOW SYNTAX RULES
	.DB	0
DTXT:	.TEXT	"DATA"		;BAD LINE OR DATA TYPE
	.DB	0
OVM:	.TEXT	"DIMENSION"	;TO MANY ARRAYS, ARGUMENT OUT OF RANGE
	.DB	0
;*
;* INFORMATIONAL MESSAGES..
;*
RDY:	.TEXT	"READY."	;READY PROMPT
	.DB	$0D,$0A,0
STMSG:	.TEXT	"STOP"		;INDICATES PROGRAM STOPPED
	.DB	0
EM:	.TEXT	" ERROR"	;INDICATES ERROR OCCURED
	.DB	0
SIMSG:	.TEXT	" BYTES"	;DISPLAYED IN RESPONSE TO 'SIZE'
	.DB	$0D,$0A,0
TXT_BASICID:	
